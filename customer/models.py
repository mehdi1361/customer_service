...
class CustomerFinancialInfo(Base):
    ...
    s_exchange_tranasction = models.IntegerField(blank=True, null=True)
    c_exchange_tranasction = models.IntegerField(blank=True, null=True)
    out_exchange_tranasction = models.IntegerField(blank=True, null=True)
    tranasction_level = models.CharField(blank=True, null=True, max_length=200)
    trading_knowledge_level = models.CharField(blank=True, null=True, max_length=200)
